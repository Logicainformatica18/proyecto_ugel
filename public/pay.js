...
function payCompare () {
  var formData = new FormData (document.getElementById ('pay'));
  formData.append ('user_option_1', document.getElementById("user_option_1").value);
  formData.append ('user_option_2', document.getElementById("user_option_2").value);
  formData.append ('user_option_3', document.getElementById("user_option_3").value);
...
function payEdit (id) {
  ...
  axios ({
    ...
    .then (function (response) {
      ...
      pay.subtotal.value =
        response.data['money'] * 0.18 * response.data['cantidad'] +
        response.data['money'] * response.data['cantidad'];
    })
    .catch (function (response) {
      //handle error
      console.log (response);
